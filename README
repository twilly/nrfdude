...
libusb-1.0 is required.  Make sure your system has development headers and not
just the binaries.
...
_WARNING_: The nRF24LU1+ loader will not run on power up! The only way to get
back into the loader is to manually jump to it in your firmware! The entry
point for the loader on my particular chip is 0x7800. I highly recommend
dumping your device's firmware and confirming the loader's memory location
before continuing. Make sure your program always has a way to get back to the
loader, such as reading a switch, if you wish to continue using nrfdude.
